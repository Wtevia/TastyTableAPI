...
public static class Consts
{
    ...
    public const string PasswordRegex = @"^(?=.*[A-Z])(?=.*[\W])(?=.*[0-9])(?=.*[a-z]).{8,128}$"; //@"^(?=.*\d)(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z]).{8,20}$"

    public const string PasswordValidationError = "Password must have more than 7 characters, min. 1 uppercase, min. 1 lowercase, min. 1 special characters.";
